...
class Measurement(models.Model):
    sensorId = models.CharField(max_length=32)
    ...
    def __str__(self):
        s = "sensor ID = " + self.sensorId + ", time = " + str(self.time) + \
            ", lat = " + str(self.lat) + ", lon = " + str(self.lon) + ", ele = " + str(self.ele) + \
            ", pm25 = " + str(self.pm25) + ", pm10 = " + str(self.pm10)
        return s